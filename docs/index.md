...
!!! info
    ...
    **Source Code Repository:** [https://github.com/fpetk-rolling-demo/test-chatbot-2025102401](https://github.com/fpetk-rolling-demo/test-chatbot-2025102401)

    **GitOps Repository:** [https://github.com/fpetk-rolling-demo/test-chatbot-2025102401-gitops](https://github.com/fpetk-rolling-demo/test-chatbot-2025102401-gitops)

# **Usage**

To access the test-chatbot-2025102401 application that was deployed using the Software Template, complete the following instructions:
