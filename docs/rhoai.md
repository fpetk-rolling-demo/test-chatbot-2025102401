...
3) Access the `workbench` named `test-chatbot-2025102401-notebook`.
...
5) In the terminal, run `cd test-chatbot-2025102401` to navigate to your sample app's directory.
